async function miscTab() {
    const elementsConfig = [
        ...
        {config: "dataConfig", html: "Button", id: 'openedInventory', label: 'Update opened cards info', onEvent: { key: "openedInventory", event: "update-data-config" }, group: 'Club', data: "lastUpdate", subkey: "openedInventory" },
    ...
    tab.tabData = [["functionConfig", null], ["miscConfig", ["clubBoost"]], ["dataConfig", ["lastUpdate"]]];
